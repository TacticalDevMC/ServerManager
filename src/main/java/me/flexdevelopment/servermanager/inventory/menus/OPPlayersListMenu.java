...
public class OPPlayersListMenu {

    @Getter
    private static String playersListInventoryName = color("&3Manager &7" + Icons.ARROW + " &3&lOP-Players");
    ...
    public void open(Player player) {
        ...
        for (OfflinePlayer players : Bukkit.getServer().getOperators()) {
            ItemStack playerStack = CreateItemStacks.createSkullWithOwner(players.getName(), color("&6" + players.getName()), "", color("&7De speler &6" + players.getName() + " &7heeft OP."), "");
